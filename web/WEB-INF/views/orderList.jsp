    ...
    <div class="container">
        <div class="section">
            ...
            <%
                ...
                orders.add(Map.of("id", "1", "title", "맥북 팝니다", "author", "123", "price", "₩1,200,000", "description", "고성능 노트북입니다.", "file", "/upload/mac.jpg"));
                orders.add(Map.of("id", "2", "title", "z플립 팝니다", "author", "123", "price", "₩800,000", "description", "최신 스마트폰입니다.", "file", "/upload/z6.jpg"));
            ...
            <div class="post">
                ...
                <div class="post-file">
                    <img src="<%=order.get("file")%>" alt="첨부파일">
                </div>
            </div>
            <%
                }
