    ...
    <div class="container">
        <div class="content">
            ...
            <div class="form-container">
                <form action=""${pageContext.request.contextPath}/writeProduct.do" method="post" enctype="multipart/form-data">
                    <!-- Hidden field to pass user ID -->

                    <!-- Product Title -->
                    <label for="product_name">제목</label>
                    <input type="text" id="title" name="productName" required placeholder="제품 제목을 입력하세요">
