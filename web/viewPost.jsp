            ...
            <div class="wishlist-message">
                <c:choose>
                    <c:when test="${not empty sessionScope.user_id}">
                        <a href="writeBlame.do?author=${to.user_id}&postTitle=${to.productName}" class="report-button">신고하기</a>
                    </c:when>
                    <c:otherwise>
                ...
                <c:choose>
                    ...
                    <c:otherwise>
                        <c:choose>
                            <c:when test="${sessionScope.user_id != to.user_id}">
                                <form action="wishList.do" method="post" style="display: inline;">
                ...
                <c:choose>
                    <c:when test="${empty sessionScope.user_id}">
                        <button class="message-button" onclick="requireLogin()">쪽지 보내기</button>
                    </c:when>
                    <c:otherwise>
                        <c:choose>
                            <c:when test="${sessionScope.user_id != to.user_id}">
