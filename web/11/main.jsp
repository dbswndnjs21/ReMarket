...
<body>
	...
	<div class="container">
					<!-- 검색 기능 -->
			<form action="searchProduct.do" method="get" onsubmit="return validateSearch()">
            <div class="block search-condition">
                ...
                <span class="form-group">
                    <input type="text" id="searchInput" name="searchInput" class="search-input" placeholder="검색어를 입력하세요">
                </span>
